...
public class GMLVQ_1 {
    ...
    public static List<AbstractOptimizer<GMLVQOptParam>> getOpts() {
        ...
        List<AbstractOptimizer<GMLVQOptParam>> opts = Arrays.asList(
                (AbstractOptimizer<GMLVQOptParam>) new VSGD<GMLVQOptParam>(1, 1, eps, tMax, -1),
                ...
                (AbstractOptimizer<GMLVQOptParam>) new SGD<GMLVQOptParam>(1, 0.1, eps, tMax, -1),
                (AbstractOptimizer<GMLVQOptParam>) new WA_BGD<GMLVQOptParam>(0.1, 5, 0.9, 1.1, eps, tMax, -1),
                (AbstractOptimizer<GMLVQOptParam>) new WA_SGD<GMLVQOptParam>(1,0.1, 5, 0.9, 1.1, eps, tMax, -1)
        );
        return opts;
    }
}
