...
public class OptimizerFactory {
    ...
    public static <ParamType extends OptParam<ParamType>> BGD<ParamType> createBGD(Arguments a) {
        return new BGD<>(a.getDbl("rate"),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> SGD<ParamType> createSGD(Arguments a) {
        return new SGD<>(a.getLong("seed",1),a.getDbl("rate"), a.getDbl("epsilon"), a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> VSGD<ParamType> createVSGD(Arguments a) {
        return new VSGD<>(a.getLong("seed",1),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> WA_SGD<ParamType> createWASGD(Arguments a) {
        return new WA_SGD<>(a.getLong("seed", 1),a.getDbl("rate"),a.getInt("hist"),a.getDbl("loss",1),a.getDbl("gain",1),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> WA_BGD<ParamType> createWABGD(Arguments a) {
        return new WA_BGD<>(a.getDbl("rate",1),a.getInt("hist",5),a.getDbl("loss",1.5),a.getDbl("gain",1.1),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> Adadelta<ParamType> createAdadelta(Arguments a) {
        return new Adadelta<>(a.getLong("seed"),a.getInt("batchSize",1),a.getDbl("rho",0.95),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> Adadelta<ParamType> createAdadeltaBatch(Arguments a) {
        return new Adadelta<>(a.getLong("seed"),a.getInt("batchSize",Integer.MAX_VALUE),a.getDbl("rho",0.95),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> Adam<ParamType> createAdam(Arguments a) {
        return new Adam<>(a.getLong("seed"),a.getInt("batchSize",1),a.getDbl("alpha",0.001),a.getDbl("beta1",0.9),a.getDbl("beta2",0.999),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> Adam<ParamType> createAdamBatch(Arguments a) {
        return new Adam<>(a.getLong("seed"),a.getInt("batchSize",Integer.MAX_VALUE),a.getDbl("alpha",0.001),a.getDbl("beta1",0.9),a.getDbl("beta2",0.999),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    ...
    public static <ParamType extends OptParam<ParamType>> SlowStartSGD<ParamType> createSlowStartSGD(Arguments a) {
        ...
        return new SlowStartSGD<>(rates,a.getLong("seed"),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    ...
    public static <ParamType extends OptParam<ParamType>> WaypointAverage<ParamType> createWA(Arguments a) {
        ...
        return new WaypointAverage<>(base,a.getInt("hist"),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> ControlledBGD<ParamType> createControlledBGD(Arguments a) {
        return new ControlledBGD<>(a.getDbl("rate"),a.getDbl("loss"),a.getDbl("gain"),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
    
    public static <ParamType extends OptParam<ParamType>> ControlledSGD<ParamType> createControlledSGD(Arguments a) {
        return new ControlledSGD<>(a.getLong("seed", 1),a.getDbl("rate"),a.getDbl("loss"),a.getDbl("gain"),a.getDbl("epsilon"),a.getInt("tmax"),a.getLong("nsmax"));
    }
}
